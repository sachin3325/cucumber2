...
public class Exhibitor_Form_test 
{
	...
	public void user_enters_the_e_mail() throws InterruptedException 
	{
		 ...
		 * "//body[1]/main[1]/article[1]/section[1]/form[1]/fieldset[1]/div[1]/div[11]/div[1]/input[1]"
		 * )); email.sendKeys("sachinanand584@gmail.com"); Thread.sleep(3000);
		 */
	}
	...
	public void user_clicks_the_acknowledge_checkbox() throws InterruptedException 
	{
		 ...
		 * driver.findElement(By.xpath("//input[@id='acknowledge_check']"));
		 * acknowledge.click(); Thread.sleep(3000);
		 */
	}
